...
| **Platform agents** | Reusable agent definitions that run multi-turn conversations in chat and channel rooms |
...
- **MCP instance** — A deployed tool server in your project with configuration and connection wiring.
