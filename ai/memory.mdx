...
| Document Q&A across uploads | Index uploaded files, search at query time |
...
<Note>
  Auto-indexing behavior is configured per workspace by AgentRuntime — it is not yet a Console toggle. Contact [support](mailto:support@agentruntime.io) if you want auto-indexing enabled or adjusted for your workspace.
</Note>
...
| `work file not found` | Verify `file_id` exists and the file is still available |
