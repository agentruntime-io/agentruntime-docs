...
Workspaces are identified by a unique **slug** used in URLs and API calls (`X-Tenant-Id` header).
...
Workflow **mcp_call** steps target a specific instance and tool name.
