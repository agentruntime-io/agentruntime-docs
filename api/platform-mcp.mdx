...
|-------|-------|------------|
| **core** | Workflows, runs, analytics, health | Standard |
...
| `workflows_execute_command` | `POST /v1/workflows/{id}/command` | Start/pause/resume/stop |
| `workflows_list_runs` | `GET /v1/workflows/{id}/runs` | List runs |
