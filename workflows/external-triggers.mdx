...
**Deprecated 2026-06-28.** New schedules and integrations should send **full start params** explicitly. Existing deployments may still merge until migrated — see internal [Run setup evolution log](https://github.com/agentruntime-io/agentruntime/blob/develop/docs/workflows/WORKFLOW_RUN_SETUP_EVOLUTION.md).
...
Scheduler + dispatcher run in control-service. REST: `GET/POST/PATCH/DELETE /workflows/{id}/triggers`.
