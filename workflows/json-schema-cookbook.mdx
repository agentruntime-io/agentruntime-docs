...
**Legacy shapes:** Do not use `for_each_body`, slug step ids, or catalog-agent-only canvas nodes. Monorepo reference: `docs/workflows/WORKFLOW_LEGACY_AND_COMPAT.md`.
